...
Eesse projeto foi desenvolvido durante o curso de [TypeScript](https://www.udemy.com/course/typescript-do-basico-ao-avancado-c-react-express/). Utilizou-se o [Vite](https://vitejs.dev/guide/) para a criação do projeto e deploy na [Netlify](https://app.netlify.com)
